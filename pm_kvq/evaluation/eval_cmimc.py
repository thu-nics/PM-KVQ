...
DEFAULT_DATASET_PATH = "datasets/cmimc/"


def eval_cmimc(model, tokenizer, dataset_path=DEFAULT_DATASET_PATH, version=2024, n_responses=1, record=True, output_path=None, start=None, end=None, seed=42, **kwargs):
    json_data = {}
